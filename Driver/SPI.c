...
void SPI_Initilize(void)
{
    ...
    */
    //以下为硬件实现
    //1.初始化GPIO配置
    RCC_AHB1PeriphClockCmd(SPI_GPIO_CLK, ENABLE);//使能GPIOA时钟.stm32f4系列中GPIO都属于AHB1总线
    GPIO_InitTypeDef GPIO_InitStructure;
    GPIO_InitStructure.GPIO_Pin =SPI_SCK_PIN | SPI_MOSI_PIN | SPI_MISO_PIN;//SCK、MOSI、MISO引脚
